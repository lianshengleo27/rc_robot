...
def main():
    ...
    while not navigator.isTaskComplete():
        ...
        # Do Something (i..e, stop for 5 sec)
        if feedback and feedback.current_waypoint < len(inspection_points):
            print(f'Reached waypoint {feedback.current_waypoint + 1}, stopping for 5 seconds...')
